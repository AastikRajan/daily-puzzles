...
import { typeStats, allStreak } from '../lib/streaks';
  ...
  return (
    <div className="view">
      ...
      <div className="stats-hero">
        ...
        <div>
          <span className="stats-big">{Math.floor(Object.keys(completions).length / 3)}</span>
          <span className="stats-cap">full days</span>
        </div>
      </div>
