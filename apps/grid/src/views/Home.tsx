...
import { TYPE_META, TYPE_ORDER, TYPE_EMOJI } from '../lib/meta';
...
function Card({ type, date }: { type: GridPuzzleType; date: string }) {
  ...
  return (
    <div className="view home">
      <header className="masthead">
        <div className="masthead-row">
          <span className="brand-mark" aria-hidden>
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
              {/* Crown mark */}
              <path d="M3 16h16M3 16l2-7 4 4 2-6 2 6 4-4 2 7" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
            </svg>
          </span>
        ...
        <h1 className="masthead-title">Daily Grid</h1>
      ...
      <footer className="home-foot">
        ...
        {viewingToday ? (
          ...
          <button className="btn3d ghost" onClick={() => setDate(today)}>
            ← Back to today
          </button>
        )}
      </footer>
